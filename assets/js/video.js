 ...
 */
        ...
        MediaError.defaultMessages = {
            1: 'شما پخش رسانه را قطع کردید',
            2: 'یک خطای شبکه موجب شد تا دانلود رسانه قطع شود.',
            3: 'پخش رسانه ای به مشکل خورد .مرورگر شما پشتیبانی نمی کند ، از مرورگر گوگل کروم استفاده کنید.',
            4: 'رسانه ها را نمی توان بارگذاری کرد، یا به دلیل اینکه سرور یا شبکه مشکل دارد یا به این دلیل که فرمت فایل پشتیبانی نمی شود ، لطفا از مرورگر گوگل کروم استفاده کنید.',
            5: 'رسانه ها رمزگذاری شده اند و کلید رمزگشایی آن را نداریم.'
        };
